...
function AdmineRead() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:8081/readteacher/${id}`)
            .then(res => {
                setadmine(res.data);
                consol
            })
          ...
          <div className="col-lg-4">
            <div className="card mb-4">
              <div className="card-body text-center">
                ...
                <h5 className="my-3"> <> {admine && admine[0].ADMIN_NAME}</></h5>
              ...
              <div className="card-body">
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0"> <> {admine && admine[0].ADMIN_NAME}  </>   </p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0"><>  {admine && admine[0].ADMIN_MAIL} </></p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0"><> {admine && admine[0].ADMIN_PHONE} </></p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{admine && admine[0].ADMIN_PASSWORD} </p>
                  </div>
                </div>
                <hr />
                <div className="row">
                  ...
                  <div className="col-sm-9">
                    <p className="text-muted mb-0">{admine && admine[0].ADMIN_ADDRESS} </p>
                  </div>
                </div>
              </div>
            </div>
